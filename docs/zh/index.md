...
- **[前端](https://github.com/npanel-dev/frontend)**：React 19 UI + VitePress 文档，同时覆盖管理端与用户端。
- **[NPanel Server](https://github.com/npanel-dev/server)**：Go 1.21+ API，兼顾隐私、可观测性与多协议调度。
- **[NPanel](https://github.com/npanel-dev/NPanel)**：打包 gateway 与后端二进制的 Docker 镜像，一条命令即可启动。
