...
- **[Frontend](https://github.com/npanel-dev/frontend)** — React 19 UI + VitePress docs for both admin and user portals.
- **[NPanel Server](https://github.com/npanel-dev/server)** — Go 1.21+ APIs focusing on privacy, observability, and multi-protocol orchestration.
- **[NPanel](https://github.com/npanel-dev/NPanel)** — Docker image that ships the compiled gateway plus backend binaries so you can launch everything with one container.
